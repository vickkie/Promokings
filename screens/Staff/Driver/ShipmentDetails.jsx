  ...
  const PaymentMethodComponent = ({ item }) => {
    ...
    return (
      <View>
        ...
        <View style={styles.inputWrapper}>
          <Icon name="city" size={29} style={styles.iconStyle} color={COLORS.gray} />
          <TextInput placeholder="city" style={{ flex: 1 }} value={item?.shippingInfo?.city} editable={false} />
        </View>
        <View style={styles.inputWrapper}>
          <Icon name="location" size={29} style={styles.iconStyle} color={COLORS.gray} />
          <TextInput placeholder="" style={{ flex: 1 }} value={item?.shippingInfo?.address} editable={false} />
        </View>
      </View>
    );
  };
          ...
          <View style={styles.upperRow}>
            ...
            <View style={styles.stepsheader}>
              <Text style={styles.stepstext}>
                {data?.assignedAt ? new Date(data.assignedAt).toDateString() : "Not Assigned"}
              </Text>
            </View>
          </View>
          <ScrollView>
                  ...
                  <ScrollView>
                    <View style={styles.stepContainer}>
                      <View style={{ justifyContent: "center", marginVertical: 20 }}>
                        <Text style={styles.relatedHeader}>Delivery items</Text>
                      </View>
                  ...
                  <View style={styles.wrapperRelated}>
                    <View style={styles.leftRelated}>
                      ...
                      <View style={{ gap: 5, alignItems: "flex-start", paddingTop: 3, marginStart: 6 }}>
                        <Text style={styles.supplierHead}>
                          {customerDetails?.fullName || customerDetails?.username}
                        </Text>
