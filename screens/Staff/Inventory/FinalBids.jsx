...
const FinalBids = () => {
  ...
  const [statuses, setstatuses] = useState(["Pending", "Accepted", "Rejected", "Closed"]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topWelcomeWrapper}>
        <View style={styles.appBarWrapper}>
          <View style={styles.appBar}>
            ...
            <Text style={styles.greetingMessage}>
              <Text style={styles.username}>Supply Bids </Text>
            </Text>
        ...
        <View style={styles.totalWrapper}>
          <Text style={styles.totalCount}>{filteredData.length} Products in Supplier Bids</Text>
        </View>
      </View>
