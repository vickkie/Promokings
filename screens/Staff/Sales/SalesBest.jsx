...
import ProductListCard from "./SalesBestCard";
...
const BestProductList = () => {
  ...
  const { data: selling, isLoading, error, refetch } = useFetch(products, true, userData?.TOKEN);
  ...
  useEffect(() => {
    if (!isLoading && selling.success && selling.topSelling) {
      setData(selling.topSelling);
    }
  }, [selling, isLoading]);
        ...
        <View style={styles.appBarWrapper}>
          <View style={styles.appBar}>
            ...
            <Text style={styles.greetingMessage}>
              <Text style={styles.username}>Best selling</Text>
            </Text>
